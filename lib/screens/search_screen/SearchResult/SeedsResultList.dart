...
class SeedsSearchResultList extends StatefulWidget {
  final int category_id;
  final int search_id;
  final String query;

  const SeedsSearchResultList({required this.category_id, required this.search_id, required this.query});

  @override
  State<SeedsSearchResultList> createState() => _SeedsSearchResultListState();
}

class _SeedsSearchResultListState extends State<SeedsSearchResultList> {
  var ds;
