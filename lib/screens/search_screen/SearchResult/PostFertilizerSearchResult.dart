...
class FertilizerSearchResultList extends StatefulWidget {
  final int category_id;
  final int search_id;
  final String query;

  const FertilizerSearchResultList({
  ...
  @override
  State<FertilizerSearchResultList> createState() =>
      _FertilizerSearchResultListState();
}

class _FertilizerSearchResultListState extends State<FertilizerSearchResultList> {
  var ds;
