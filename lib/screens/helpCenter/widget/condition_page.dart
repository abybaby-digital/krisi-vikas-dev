    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          barlowRegular(
            text:
                "Welcome to Krishi Vikas’s Terms of Use This legal agreement is an electronic record in terms of the Information Technology Act, 2000 and rules there under as applicable and the amended provisions about electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "i.For the purpose of these Terms of Use (“Terms of Use”), wherever the context so requires, “We”, “Firm”, “Our”, and “Us” shall mean and refer to the Application",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text:
                "ii.	“You”, “Your”, “Yourself”, “User”, “Vendor”, “Service Provider” and “Customer” shall mean and refer to natural and legal individuals who shall be users of this Application provided by us and who is competent to enter into binding contracts, as per Indian laws.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text:
                "iii.	“Third Parties” refer to any Application or individual apart from the Users and the creator of this Application.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "iv.	Geo-location",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "v.	Date of Birth ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "You agree to indemnify, defend and hold harmless the Us, and our respective directors, officers, employees and agents (collectively, "
                "Parties"
                "),"
          ...
          barlowRegular(
            text: "a.	Your use of the Application,",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "b.	Your violation of these Terms of Use;  ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "c.	Your violation of any rights of another;  ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "e.	Your conduct in connection with the Application;  ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "You can report to support@krishivikas.com if you find any discrepancy with regard to Application or content-related information and we will take necessary action after an investigation.  The response with resolution (if any issues found) shall be dependent on the time is taken for investigation.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "USER OBLIGATIONS AND FORMAL UNDERTAKINGS AS TO CONDUCT",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "c.You agree that You are solely responsible for maintaining the confidentiality of your account password. You agree to notify us immediately of any unauthorized use of your account. We reserve the right to close your account at any time for any or no reason.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text:
                "d. User represents and warrants that the Firm may offer other additional accidental insurance packages from any third parties, which will benefit the user. However, the Firm does not guarantee the user the same at any time.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text:
                "e. Authorize the Application to use, store or otherwise process certain personal information and all published Content, responses, locations, User comments, reviews and ratings for personalization of Services, marketing and promotional purposes and for optimisation of User-related options and Services.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "h.Agree that promotions and giveaways are governed by a different set of rules. ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "j.Expressly agree and acknowledge that the Content generated by the Users and displayed on the Application is not owned by Us and that We are in no way responsible for the content of the same. You may, however, report any offensive or objectionable content, which We may then remove from the Application, at our sole discretion.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "i.Commit any act that causes Us to lose (in whole or in part) the Services of its Internet Establishment ("
                "ISP"
                ") or in any manner disrupts the Services of any other supplier/service provider of the Application;",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "iii.	is in any way harmful to minors;",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "v.	violates any law for the time being in force;",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "SUSPENSION OF USER ACCESS AND ACTIVITY",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text: "DISPUTE RESOLUTION AND JURISDICTION",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "In the event the parties are unable to resolve any such dispute through mediation within 45 days of the initiation of the dispute, subject to a contrary agreement between the parties, the dispute shall be finally resolved by arbitration administered by CORD and conducted in accordance with the Rules of Arbitration of CORD, by a sole arbitrator to be appointed by CORD. The language of arbitration shall be English. The seat of arbitration shall be Kolkata,  India.",
            size: 15,
            color: grey,
          ),
          barlowRegular(
          ...
          barlowRegular(
            text:
                "d.	Contact Us: If you have any questions about these Terms of Use, the practices of the Application, or your experience, you can contact us by emailing at support@krishivikas.com or by writing to us at : ",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "M/s Abybaby E-Com Private Limited,",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "Ground Floor, 4B, Rani Bhabani Road,",
            size: 15,
            color: grey,
          ),
          barlowRegular(
            text: "Kolkata, West Bengal - 700026",
            size: 15,
            color: grey,
          ),
        ]),
