...
class HarvesterImageUpdateScreen extends StatefulWidget {
  final String? set;
  final String? setType;
  final String? rentType;
  final String? cropType;
  final String? cuttingWith;
  ...
  const HarvesterImageUpdateScreen({
    this.setType,
    this.rentType,
    this.price,
    this.rcAvailabel,
  ...
  @override
  State<HarvesterImageUpdateScreen> createState() => _HarvesterImageUpdateScreenState();
}

class _HarvesterImageUpdateScreenState extends State<HarvesterImageUpdateScreen> {
  bool showCPI = false;
            ...
            onTap: () async {
              ...
              if (count >= 1) {
                ...
                FormData formData = FormData.fromMap({
                  ...
                  'cutting_with':widget.cuttingWith,
                  'power_source':widget.powerSource,
                  'price':widget.price,
