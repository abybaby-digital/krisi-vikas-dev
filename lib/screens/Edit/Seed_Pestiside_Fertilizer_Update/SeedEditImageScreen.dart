...
class SeedsEditImageScreen extends StatefulWidget {
  final String? title;
  final int? price;
  ...
  const SeedsEditImageScreen(
      {Key? key, this.title, this.price, this.isNegotiable, this.description, this.ds}
      ) : super(key: key);

  @override
  State<SeedsEditImageScreen> createState() => _SeedsEditImageScreenState();
}

class _SeedsEditImageScreenState extends State<SeedsEditImageScreen> {
  bool showCPI = false;
