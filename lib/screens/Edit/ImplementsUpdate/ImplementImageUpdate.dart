...
class ImplemenetImageUpdateScreen extends StatefulWidget {
  final String? set;
  ...
  const ImplemenetImageUpdateScreen({
    this.setType,
    this.rentType,
    this.price,
    this.isNegotiable,
  ...
  @override
  State<ImplemenetImageUpdateScreen> createState() => _ImplemenetImageUpdateScreenState();
}

class _ImplemenetImageUpdateScreenState extends State<ImplemenetImageUpdateScreen> {
  bool showCPI = false;
          ...
          children: [
            ...
            Padding(
              ...
              child: GridView.builder(
                shrinkWrap: true,
                itemCount: assetImages.length-2,
