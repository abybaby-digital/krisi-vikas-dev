...
import 'package:krishivikas/screens/Edit/ImplementsUpdate/ImplementImageUpdate.dart';
import 'package:krishivikas/screens/Edit/Post_Update/postUpdateImplements.dart';
...
class ImplementEditScreen extends StatefulWidget {
  final ds;
  const ImplementEditScreen({Key? key, required this.ds}) : super(key: key);

  @override
  State<ImplementEditScreen> createState() => _ImplementEditScreenState();
}

class _ImplementEditScreenState extends State<ImplementEditScreen> {
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            goto(context, ImplemenetImageUpdateScreen(
          ...
          GestureDetector(
            onTap: () async {
              FormData formData = FormData.fromMap({
                ...
                "id":widget.ds['id'],
                "set":_setController.text.trim().isEmpty?'${widget.ds['set']}':_setController.text.trim().toLowerCase(),
