...
class PostGvDetailScreen extends StatefulWidget {
  final int gv_id;
  ...
  @override
  State<PostGvDetailScreen> createState() => _PostGvDetailScreenState();
}

class _PostGvDetailScreenState extends State<PostGvDetailScreen> {
