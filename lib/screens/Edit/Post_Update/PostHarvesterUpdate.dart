...
class postHarvesterDetailScreen extends StatefulWidget {
  final int harvester_id;

  postHarvesterDetailScreen(
      this.harvester_id,
      );

  @override
  State<postHarvesterDetailScreen> createState() => _postHarvesterDetailScreenState();
}

class _postHarvesterDetailScreenState extends State<postHarvesterDetailScreen> {
