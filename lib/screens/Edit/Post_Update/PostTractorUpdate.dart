...
class PostTractorDetailScreen extends StatefulWidget {
  final int tractor_id;

  PostTractorDetailScreen(
      this.tractor_id,
      );

  @override
  State<PostTractorDetailScreen> createState() => _PostTractorDetailScreenState();
}

class _PostTractorDetailScreenState extends State<PostTractorDetailScreen> {
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Front", imageUrl: '${ds[0]['front_image']}'));
                            },
                            child:CachedNetworkImage(
                              imageUrl: ds[0]['front_image'],
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Back", imageUrl: '${ds[0]['back_image']}'));
                            },
                            child: CachedNetworkImage(
                              imageUrl: ds[0]['back_image'],
                              imageBuilder: (context, imageProvider) =>
                                  Container(
                                    width: fullWidth(context),
                                    height: 350,
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Left", imageUrl: '${ds[0]['left_image']}'));
                            },
                            child: CachedNetworkImage(
                              imageUrl: ds[0]['left_image'],
                              imageBuilder: (context, imageProvider) =>
                                  Container(
                                    width: fullWidth(context),
                                    height: 350,
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Right", imageUrl: '${ds[0]['right_image']}'));
                            },
                            child: CachedNetworkImage(
                              imageUrl: ds[0]['right_image'],
                              imageBuilder: (context, imageProvider) =>
                                  Container(
                                    width: fullWidth(context),
                                    height: 350,
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Meter", imageUrl: '${ds[0]['meter_image']}'));
                            },
                            child: CachedNetworkImage(
                              imageUrl: ds[0]['meter_image'],
                              imageBuilder: (context, imageProvider) =>
                                  Container(
                                    width: fullWidth(context),
                                    height: 350,
                      ...
                      Stack(
                        children: [
                          GestureDetector(
                            onTap:(){
                              goto(context, PhotoSelectView(side: "Tyre", imageUrl: '${ds[0]['tyre_image']}'));
                            },
                            child: CachedNetworkImage(
                              imageUrl: ds[0]['tyre_image'],
                              imageBuilder: (context, imageProvider) =>
                                  Container(
                                    width: fullWidth(context),
                                    height: 350,
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: ds[0]["rc_available"] == "true" ? yes.tr : no.tr,
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: ds[0]["noc_available"] == "true" ? yes.tr : no.tr,
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: ds[0]["registration_no"].toString(),
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: ds[0]["year_of_purchase"].toString(),
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: ds[0]["is_negotiable"] == "true" ? yes.tr : no.tr,
                    size: 14,
                    color: black,
                  ),
                ],
