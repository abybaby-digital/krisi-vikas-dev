...
class PostSeedDetailScreen extends StatefulWidget {
  final int seed_id;
  final String categoryId;

  PostSeedDetailScreen(
      this.seed_id,
      this.categoryId,
      );

  @override
  State<PostSeedDetailScreen> createState() => _PostSeedDetailScreenState();
}

class _PostSeedDetailScreenState extends State<PostSeedDetailScreen> {
  ...
  fetchData() async{
    await ApiMethods().getSingleTractorInfoById(
        baseUrl+getUrlByCategory(widget.categoryId),
        SharedPreferencesFunctions.userId!,
        SharedPreferencesFunctions.token!,
        widget.seed_id).then((value) {
      print('---Value---');
      print(value);
      setState(() {
        ds = value;
  ...
  getUrlByCategory(String Category_Id) {
    if (Category_Id == "6") {
      ...
      return "pesticides-by-id";
    } else if (Category_Id == "9") {
      return "fertilizer-by-id";
    }
  }
  ...
  getListForSlider() async {
    if (ds[0]['image1'] != "") {
      ...
      SliderListItem["imageItem"] = ds[0]['image1'];
    ...
    if (ds[0]['image3'] != "") {
      ...
      SliderListItem["imageItem"] = ds[0]['image3'];
    ...
    if (ds[0]['image2'] != "") {
      ...
      SliderListItem["imageItem"] = ds[0]['image2'];
