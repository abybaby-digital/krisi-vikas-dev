...
class PostImplementDetailScreen extends StatefulWidget {
  final int implemenet_id;

  PostImplementDetailScreen(
      this.implemenet_id,
      );

  @override
  State<PostImplementDetailScreen> createState() => _PostImplementDetailScreenState();
}

class _PostImplementDetailScreenState extends State<PostImplementDetailScreen> {
