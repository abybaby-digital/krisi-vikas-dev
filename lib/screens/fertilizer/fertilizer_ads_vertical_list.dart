...
import 'package:krishivikas/screens/filter/filter_screen_seeds.dart';
...
class FertilizerAdsVerticalList extends StatefulWidget {
  final String? categoryName;
  final int? categoryId;

  const FertilizerAdsVerticalList({
    this.categoryName,
    this.categoryId,
  });

  @override
  State<FertilizerAdsVerticalList> createState() =>
      _FertilizerAdsVerticalListState();
}

class _FertilizerAdsVerticalListState extends State<FertilizerAdsVerticalList> {
  var ds;
