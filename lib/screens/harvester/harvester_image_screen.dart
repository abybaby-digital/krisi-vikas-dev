...
class HarvestorImagesScreen extends StatefulWidget {
  final String? setType;
  final String? type;
  final String? rentType;
  final String? cropType;
  final String? cuttingWidthValue;
  final String? powerSourceValue;
  final int? price;
  ...
  @override
  State<HarvestorImagesScreen> createState() => _HarvestorImagesScreenState();
}

class _HarvestorImagesScreenState extends State<HarvestorImagesScreen> {
  String url = "";
  ...
  List<String> assetImages = [
    "assets/harvester_left.png",
    "assets/harvester-right.png",
    "assets/harvester-front.png",
    "assets/harvester-back.png",
  ];
            ...
            onTap: () async {
              ...
              if (images[2] == "") {
                ...
                FormData formData = FormData.fromMap({
                  ...
                  "year_of_purchase": widget.yearOfPurchase.toString(),
                  "crop_type": widget.cropType,
                  "rent_type": widget.rentType ?? "",
                  "cutting_with": widget.cuttingWidthValue,
                  "power_source": widget.powerSourceValue,
