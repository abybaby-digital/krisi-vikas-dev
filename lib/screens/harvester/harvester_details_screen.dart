...
import '../Edit/Harvester_Update/HarvesterEditPost.dart';
import '../Edit/Tractor_GoodVehical/EditScreen.dart';

class HarvesterDetailsScreen extends StatefulWidget {
  final ds;

  HarvesterDetailsScreen(this.ds);

  @override
  State<HarvesterDetailsScreen> createState() => _HarvesterDetailsScreenState();
}

class _HarvesterDetailsScreenState extends State<HarvesterDetailsScreen> {
          ...
          children: [
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  goto(context, HarvesterEditScreen(ds: widget.ds,));
                },
