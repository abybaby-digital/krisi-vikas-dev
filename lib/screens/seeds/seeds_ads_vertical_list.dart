...
class SeedsAdsVerticalList extends StatefulWidget {
  final String? categoryName;
  final int? categoryId;

  const SeedsAdsVerticalList({this.categoryName, this.categoryId});

  @override
  State<SeedsAdsVerticalList> createState() => _SeedsAdsVerticalListState();
}

class _SeedsAdsVerticalListState extends State<SeedsAdsVerticalList> {
  var ds;
