...
class SeedsImageScreen extends StatefulWidget {
  const SeedsImageScreen({Key? key}) : super(key: key);

  @override
  State<SeedsImageScreen> createState() => _SeedsImageScreenState();
}

class _SeedsImageScreenState extends State<SeedsImageScreen> {
  bool showCPI = false;
            ...
            onTap: () async {
              ...
              if (images[0] == "") {
                ...
                FormData formData = FormData.fromMap({
                  ...
                  "category_id": SeedsData.categoryId ?? 6,
                  "description": SeedsData.description,
                  "image1": first_image,
                  "image2": second_image,
                  "image3": third_image,
                  "price": SeedsData.price ?? 0,
                  "is_negotiable": SeedsData.IsNegotiable,
                  "country_id": SeedsData.countryId ?? 1,
                  "state_id": SeedsData.stateId ?? 36,
                  "city_id": SeedsData.cityId ?? 1,
                  "district_id": SeedsData.districtId ?? 1234,
                  "latlong": "${SeedsData.lat},${SeedsData.long}",
                  "pincode": SeedsData.zipcode
                });
  ...
  doThisONLaunch() async {
    ...
    CategoryIdWhilePosting = SeedsData.categoryId.toString();
  }
