...
class TyresDetailsScreen extends StatefulWidget {
  final ds;

  const TyresDetailsScreen(this.ds);

  @override
  State<TyresDetailsScreen> createState() => _TyresDetailsScreenState();
}

class _TyresDetailsScreenState extends State<TyresDetailsScreen> {
          ...
          children: [
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  goto(context, TyreEditScreen(ds: widget.ds));
                },
