...
class SeedsFilterDetailsScreen extends StatefulWidget {
  final DatumSeeds ds;
  const SeedsFilterDetailsScreen({Key? key, required this.ds}) : super(key: key);

  @override
  State<SeedsFilterDetailsScreen> createState() => _SeedsFilterDetailsScreenState();
}

class _SeedsFilterDetailsScreenState extends State<SeedsFilterDetailsScreen> {
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: barlowRegular(
                                          text: memeber.tr +
                                              "   " +
                                              widget.ds.createdAtUser.toString(),
                                          size: 15,
                                          color: grey,
                                        ),
                                      ),
  ...
  doThisOnLaunch() async {
    ...
    chatRoomId = getChatRoomIdByPhoneNumbers(
        SharedPreferencesFunctions.phoneNumber.toString(), widget.ds.mobile.toString());
  }
