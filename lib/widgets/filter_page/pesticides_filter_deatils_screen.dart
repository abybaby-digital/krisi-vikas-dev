...
class PesticidesFilterDetailsScreen extends StatefulWidget {
  final PesticideDatum ds;
  const PesticidesFilterDetailsScreen({Key? key, required this.ds}) : super(key: key);

  @override
  State<PesticidesFilterDetailsScreen> createState() => _PesticidesFilterDetailsScreenState();
}

class _PesticidesFilterDetailsScreenState extends State<PesticidesFilterDetailsScreen> {
