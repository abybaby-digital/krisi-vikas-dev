...
class ImplementScreenDetails extends StatefulWidget {
  final Implement ds;
  const ImplementScreenDetails({Key? key, required this.ds}) : super(key: key);

  @override
  State<ImplementScreenDetails> createState() => _ImplementScreenDetailsState();
}

class _ImplementScreenDetailsState extends State<ImplementScreenDetails> {
