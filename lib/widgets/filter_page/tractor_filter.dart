...
import 'package:krishivikas/widgets/filter_page/tractor_details_screen.dart';
...
class _FilterScreenState extends State<FilterScreen> {
  ...
  Future<List<Datum>?> filterTractorData(String brandId, String districtId,
    ...
    // logger.e(body);
    final response = await http.post(Uri.parse(baseUrl + tractorFilterUrl),
        headers: {
    ...
    if (response.statusCode == 200) {
      ...
      //     apiValues.addAll(responseData);
      final List<Datum> ListTractorData =
      Tractor.fromJson(responseData).data.toList();
