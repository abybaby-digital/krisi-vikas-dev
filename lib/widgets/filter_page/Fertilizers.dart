...
import 'firtilizers_filter_details_screen.dart';
...
class _FertilizersScreenState extends State<FertilizersScreen> {
  ...
  List<FertilizerDatum> filterData = [];
  List initDataList = [];
  List<FertilizerDatum> listData = [];
  ...
  void initState() {
    super.initState();
    FertilizersFilterData(districtId, stateId, priceStart, priceEnd);
  ...
  Future<List<FertilizerDatum>?> FertilizersFilterData(String districtId,
      String stateId, String priceStart, String priceEnd) async {
    Map data = {
    ...
    if (response.statusCode == 200) {
      ...
      final List<FertilizerDatum> ListFertilizerData =
      FertilizersModel.fromJson(responseData).data.toList();
