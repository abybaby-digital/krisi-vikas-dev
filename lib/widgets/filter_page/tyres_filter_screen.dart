...
class TyresFilterScreenPage extends StatefulWidget {
  final Tyre ds;
  const TyresFilterScreenPage({Key? key, required this.ds}) : super(key: key);

  @override
  State<TyresFilterScreenPage> createState() => _TyresFilterScreenPageState();
}

class _TyresFilterScreenPageState extends State<TyresFilterScreenPage> {
  FavoriteController favoriteController = Get.put(FavoriteController());

  ContactNowController contactNowController = Get.put(
    ContactNowController(),
  );
                    ...
                    onPressed: () async {
                      if (CurrentUserType == 0) {
                        ...
                        await contactNowController.getContactInformation(
                          ...
                          categoryId: widget.ds.userId.toString(),
                          postId: widget.ds.id,
                          callStatus: "0",
                          messageStatus: "1",
                        );
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: widget.ds.position.toString(),
                    size: 14,
                    color: black,
                  ),
                ],
