...
class VechileDetailsScreen extends StatefulWidget {
  final DatumGd ds;

  VechileDetailsScreen(
      this.ds,
      );

  @override
  State<VechileDetailsScreen> createState() => _VechileDetailsScreenState();
}

class _VechileDetailsScreenState extends State<VechileDetailsScreen> {
                    ...
                    onPressed: () async {
                      if (CurrentUserType == 0) {
                        ...
                        Map<String, dynamic> chatRoomInfoMap = {
                          ...
                          "other_token": widget.ds.firebaseToken,
                        };

                        ///Contact Us Api Function Call For Chat
                        await contactNowController.getContactInformation(
                          postUserId: widget.ds.userId,
                          categoryId: widget.ds.categoryId,
                          postId: widget.ds.id,
                          callStatus: "0",
                          messageStatus: "1",
                        );
              ...
              onPressed: () async {
                if (widget.ds.wishlistStatus == 1) {
                  await favoriteController.deleteFavoriteProduct(
                      widget.ds.categoryId, widget.ds.id);
  ...
  getListForSlider() async {
    ...
    if (widget.ds.meterImage != "") {
      Map SliderListItem = Map();
      SliderListItem["title"] = 'Meter View';
      SliderListItem["imageItem"] = widget.ds.meterImage;
      SliderListItem["itemIndex"] = 4;
      SliderList.add(SliderListItem);
    }
    if (widget.ds.tyreImage != "") {
      Map SliderListItem = Map();
      SliderListItem["title"] = "Tyre View";
      SliderListItem["imageItem"] = widget.ds.tyreImage;
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: widget.ds.rcAvailable == "true" ? yes.tr : no.tr,
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: widget.ds.nocAvailable == "true" ? yes.tr : no.tr,
                    size: 14,
                    color: black,
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  barlowRegular(
                    text: widget.ds.registrationNo.toString(),
                    size: 14,
                    color: black,
                  ),
                ],
