...
//
//     final implementModel = implementModelFromJson(jsonString);

import 'dart:convert';

ImplementModel implementModelFromJson(String str) => ImplementModel.fromJson(json.decode(str));

String implementModelToJson(ImplementModel data) => json.encode(data.toJson());
...
class ImplementModel {
  ...
  factory ImplementModel.fromJson(Map<String, dynamic> json) => ImplementModel(
    response: json["response"],
    message: json["message"],
    data: List<Implement>.from(json["data"].map((x) => Implement.fromJson(x))),
    error: json["error"],
  );
...
class Implement {
  ...
  factory Implement.fromJson(Map<String, dynamic> json) => Implement(
    id: json["id"],
