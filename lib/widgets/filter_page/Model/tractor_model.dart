...
//
//     final tractor = tractorFromJson(jsonString);

import 'dart:convert';

Tractor tractorFromJson(String str) => Tractor.fromJson(json.decode(str));

String tractorToJson(Tractor data) => json.encode(data.toJson());
