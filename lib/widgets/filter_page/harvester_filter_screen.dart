...
import 'harvester_screen_details.dart';

class HarvesterFilterScreen extends StatefulWidget {
  final String categoryId;
  final String type;
  final String currentTabType;

  const HarvesterFilterScreen(
      {Key? key,
        required this.type,
  ...
  @override
  State<HarvesterFilterScreen> createState() => _HarvesterFilterScreenState();
}

class _HarvesterFilterScreenState extends State<HarvesterFilterScreen> {
  String sortBy = '';
  bool isChecked = false;
  List<DatumHar> filterData = [];
  List initDataList = [];
  List<DatumHar> listData = [];
  ...
  void initState() {
    super.initState();
    filterHarvesterData(brandId, districtId, stateId, priceStart, priceEnd, byYear);
    _pageController = PageController(initialPage: selectedIndex);
  }

  @override
  void dispose() {
    filterHarvesterData(brandId = "", districtId = "", stateId = "",
  ...
  Future<List<DatumHar>?> filterHarvesterData(String brandId, String districtId,
    ...
    if (response.statusCode == 200) {
      ...
      final List<DatumHar> ListTractorData =
      HarvesterModel.fromJson(responseData).data.toList();
